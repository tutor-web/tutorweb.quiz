...
function CoinView($) {
    ...
    this.renderCoinAccount = function (data, captchaCallback) {
        ...
        if (data.coin_available <= 0) {
            ...
            self.jqQuiz.append([
                ...
                el('p').html('If you do not have a wallet yet to keep them in, you can get one <a href="https://smileyco.in/#/wallets">from here</a>.'),
                ...
                el('label').text('Enter your Smileycoin address below to redeem them:'),
            ...
            // If already loaded, render. Otherwise wait & let api.js call it on load
    ...
    /** Return the Smileycoin address the user entered */
...
(function (window, $) {
    ...
    twView.stateMachine(function updateState(curState, fallback) {
        ...
        case 'view-award':
            ...
            // Add extra pop-up to confirm this is what they want to do
            if (walletAddr === '$$DONATE:EIAS' && !window.confirm("Press OK to donate *all* your SMLY to Education in a Suitcase project")) {
                walletAddr = null;
            }
