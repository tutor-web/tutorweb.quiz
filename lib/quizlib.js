...
module.exports = function Quiz(rawLocalStorage, ajaxApi) {
    ...
    this._getSubscriptions = function () {
        ...
        return Promise.resolve(self.ls.getItem('_subscriptions') || {
            children: [],
        });
    };
    ...
    this.getNewQuestion = function (opts) {
        ...
        return self._withLecture(null, function (curLecture) {
            ...
            return tryRepeatedly(function () {
                var lastAns = arrayLast(curLecture.answerQueue);
    ...
    this.syncLecture = function (lecUri, opts, progressFn) {
        ...
        return self._getLecture(lecUri).then(function (preSyncLecture) {
            if (!opts.syncForce && isSynced(preSyncLecture)) {
                // Nothing to do
                return;
            }
            ...
            return self.ajaxApi.postJson(preSyncLecture.uri, preSyncLecture).then(function (newLecture) {
                ...
                if (preSyncLecture.user !== newLecture.user) {
