    ...
    this.renderCoinAccount = function (data) {
        ...
        if (data.coinAvailable === 0) {
            ...
            self.jqQuiz.append([
                ...
                el('p').text('You have ' + withUnit(data.coinAvailable, 'smileycoin') + ' left to redeem.'),
    ...
    twView.stateMachine(function updateState(curState, fallback) {
        ...
        case 'view-award':
            quiz.updateAward(curState === 'redeem-award' ? twView.getWalletId() : null).then(function (data) {
                ...
                if (curState === 'redeem-award') {
                    twView.showAlert('info', 'Your coins have been transferred');
                }
