        ...
        return new Promise(function (resolve, reject) {
            ...
            jqAjax(args).then(function (data) {
                ...
                if (jqXHR.status === 401 || jqXHR.status === 403) {
                    reject(new Error("tutorweb::error::You are not logged in. Please " +
                                     '<a href="' + '//' + window.document.location.host + '/login?came_from=' + encodeURIComponent(window.document.location) + '">' +
