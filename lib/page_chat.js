...
function Chat(twView, roomName, userNick) {
    ...
    this.sockNs = io.connect(twView.ajaxApi.ploneUrl("/").replace(/(:\d+)?\/$/, ':8090/chat'), {
...
(function (window, $) {
    ...
    twView.states.chat_tutormenu = function () {
        ...
        return ajaxApi.getJson(twView.ajaxApi.ploneUrl('/@@quizdb-chat-tutor-settings')).then(function (data) {
    ...
    twView.states.chat_tutormenu_save = function () {
        return Promise.resolve().then(function () {
            ...
            return ajaxApi.postJson(twView.ajaxApi.ploneUrl('/@@quizdb-chat-tutor-settings'), dataOut);
        }).then(function (data) {
    ...
    twView.states.chat_pupilmenu = function () {
        return Promise.resolve().then(function () {
            return ajaxApi.postJson(twView.ajaxApi.ploneUrl('/@@quizdb-chat-prospective-tutors'), { lec_uri: twView.curUrl.lecUri });
        }).then(function (data) {
    ...
    twView.states.chat_pupilmenu_choose = function () {
        return Promise.resolve().then(function () {
            return ajaxApi.postJson(twView.ajaxApi.ploneUrl('/@@quizdb-chat-prospective-tutors'), {
    ...
    twView.states.chat_connect = function () {
        return Promise.resolve().then(function () {
            return ajaxApi.postJson(twView.ajaxApi.ploneUrl('/@@quizdb-chat-session-start'), { chat_session: twView.curUrl.roomName });
        }).then(function (data) {
    ...
    twView.states.chat_end = function () {
        ...
        return Promise.resolve().then(function () {
            return ajaxApi.postJson(twView.ajaxApi.ploneUrl('/@@quizdb-chat-session-end'), { chat_session: twView.curUrl.roomName });
        }).then(function (data) {
