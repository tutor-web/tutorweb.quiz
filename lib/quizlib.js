...
module.exports = function Quiz(rawLocalStorage, ajaxApi) {
    ...
    this.gradeSummary = function (lecture) {
        ...
        if (a.hasOwnProperty('grade_after') || a.hasOwnProperty('grade_before')) {
            out.grade = "Your grade: ";
            out.grade += a.hasOwnProperty('grade_after') ? a.grade_after : a.grade_before;
            if (a.hasOwnProperty('grade_next_right')) {
                out.grade += ", if you get the next question right: " + a.grade_next_right;
            }
        }
