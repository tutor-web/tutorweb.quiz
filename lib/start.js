...
(function (window, $) {
    ...
    twView.states.initial = function () {
        ...
        return 'sync-tutorials';
    };

    twView.states['sync-tutorials'] = twView.states['sync-tutorials-force'] = function (curState) {
        return twView.renderPromiseProgress(
    ...
    twView.states.lecturemenu = function () {
        return quiz.getAvailableLectures().then(function (tutorials) {
