...
(function (window, $) {
    ...
    twView.states['sync-subscriptions'] = twView.states['sync-subscriptions-force'] = function (curState) {
        return quiz.syncSubscriptions({ syncForce: curState === 'sync-subscriptions-force' }, function (opTotal, opSucceeded, message) {
            ...
            // Stop and give user a change to reconsider
