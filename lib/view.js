...
module.exports = function View($) {
    ...
    this.states['go-register'] = function () {
        this.ajaxApi.ploneRedirect("/@@register?came_from=" + encodeURIComponent((new URL("start.html", window.location)).toString()));
    };
    ...
    this.states['go-forgot-pass'] = function () {
        ...
        this.ajaxApi.ploneRedirect("/mail_password_form?userid=" + encodeURIComponent(creds.login));
    };
