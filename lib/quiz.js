    ...
    twView.stateMachine(function updateState(curState, fallback) {
        ...
        case 'rewrite-question':
            ...
            quiz.getNewQuestion({
                ...
                twView.renderNewQuestion(args.qn, args.a, function () {
        ...
        case 'ug-rate':
            ...
            twView.updateActions([]);
            quiz.setQuestionAnswer(curState === 'ug-skip' ? [] : $('form#tw-quiz').serializeArray()).then(function (args) {
