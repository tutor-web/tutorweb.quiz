...
module.exports = function Quiz(rawLocalStorage, ajaxApi) {
    ...
    this.getNewQuestion = function (opts) {
        ...
        return self._withLecture(null, function (curLecture) {
            ...
            if (typeof window === "object" && window.location.host && window.location.host.indexOf("mobile.") !== -1) {
    ...
    this.syncLecture = function (lecUri, syncForce, progressFn) {
        var self = this,
            opSucceeded = 0,
            opTotal = 3;
        ...
        return self._getLecture(lecUri).then(function (preSyncLecture) {
            if (!syncForce && isSynced(preSyncLecture)) {
                // Nothing to do
                return;
            }
            ...
            return self.ajaxApi.postJson(preSyncLecture.uri, preSyncLecture).then(function (newLecture) {
                ...
                return self.removeUnusedObjects();
            }).then(function (x) {
